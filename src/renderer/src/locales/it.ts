...
export default {
  ...
  banking: {
    welcome: 'Bentornato',
    subtitle: "La tua panoramica finanziaria a colpo d'occhio",
    available_balance: 'Saldo Disponibile',
    credit_score: 'Punteggio Credito',
    card_tier: 'Livello Carta',
    card_style: 'Stile',
    card_holder: 'TITOLARE',
    valid_thru: 'SCADENZA',
    card_number_full: 'Numero Carta',
    enter_name: 'Inserisci il tuo nome',
    transactions: 'Movimenti',
    filter_all: 'Tutti',
    filter_income: 'Entrate',
    filter_expenses: 'Uscite',
    no_transactions: 'Nessun movimento ancora',
    no_jobs: 'Nessun lavoro disponibile ancora',
    net_worth: 'Patrimonio Netto',
    total_income: 'Entrate Totali',
    total_expenses: 'Uscite Totali',
    total_debt: 'Debito Totale',
    income_per_sec: 'Entrate/s',
    expenses_per_sec: 'Uscite/s',
    net_flow: 'Flusso Netto',
    income_sources: 'Fonti di Reddito',
    income_business: 'Profitto Attività',
    income_jobs: 'Stipendio',
    income_realestate: 'Affitti Immobiliari',
    income_deposits: 'Interessi Depositi',
    level: 'Livello',
    lifetime_earnings: 'Guadagni Totali',
    total_transactions: 'Movimenti',
    // Nomi stili carta
    style_midnight: 'Mezzanotte',
    style_obsidian: 'Ossidiana',
    style_storm: 'Tempesta',
    style_imperial: 'Imperiale',
    style_amber: 'Ambra',
    style_bronze: 'Bronzo',
    style_silver: 'Argento',
    style_arctic: 'Artico',
    style_chrome: 'Cromo',
    style_onyx: 'Onice',
    style_carbon: 'Carbonio',
    style_void: 'Vuoto',
    ...
    tx_loan_received: 'Prestito ricevuto',
    tx_loan_repay: 'Rimborso prestito',
    tx_loan_repay_full: 'Prestito estinto',
    tx_loan_default: 'Penale insolvenza',
    tx_loan_margin_call: 'Margin call',
    tx_stock_buy: 'Acquisto azioni — {name}',
    tx_stock_sell: 'Vendita azioni — {name}',
    tx_stock_dividend: 'Pagamento dividendi',
    tx_crypto_buy: 'Acquisto crypto — {name}',
    tx_crypto_sell: 'Vendita crypto — {name}',
    tx_crypto_staking: 'Premio staking',
    tx_re_scout: 'Ricognizione immobili',
    tx_re_buy: 'Acquisto immobile — {name}',
    tx_re_sell: 'Vendita immobile — {name}',
    tx_re_renovate: 'Ristrutturazione — {name}',
    tx_re_repair: 'Riparazione — {name}',
    tx_re_improve: 'Miglioramento — {name}',
    tx_re_rent: 'Reddito da affitto',
    tx_shop_buy: 'Acquisto negozio',
    tx_shop_sell: 'Vendita al negozio',
    tx_shop_restore: 'Restauro oggetto',
    tx_shop_upgrade: 'Potenziamento slot',
    tx_shop_auction_list: 'Commissione asta',
    tx_shop_auction_sold: 'Ricavato asta',
    tx_storage_auction: 'Ingresso asta magazzino',
    tx_storage_buy_unit: 'Acquisto unità magazzino',
    tx_storage_sell: 'Oggetto venduto',
    tx_storage_appraise: 'Perizia oggetto',
    tx_storage_refund: 'Rimborso asta',
    tx_bm_deal: 'Affare mercato nero',
    tx_bm_deal_reward: 'Ricompensa affare',
    tx_bm_deal_loss: 'Perdita affare',
    tx_bm_fine: 'Multa indagine',
    tx_bm_hire: 'Contatto assunto',
    tx_bm_sell: 'Vendita mercato nero',
    tx_bm_forge: 'Costo falsificazione',
    tx_bm_contraband: 'Ricavo contrabbando',
    tx_bm_bribe: 'Corruzione',
    tx_gambling_bet: 'Scommessa',
    tx_gambling_win: 'Vincita gioco',
    tx_achievement_reward: 'Obiettivo: {name}',
    tx_prestige_bonus: 'Bonus prestigio',
    ...
    tx_atm_deposit_cash: 'Deposito ATM (contanti addebitati)',
    tx_atm_deposit_card: 'Deposito ATM accreditato su carta',
    // Livelli carta
  ...
  atm: {
    ...
    deposit: 'Deposita su Carta',
    deposit_amount: 'Deposito',
    added_to_card: 'Accreditato sulla Carta',
    deducted_from_wallet: 'Addebitato dal Portafoglio',
    mode_withdraw: 'Prelievo',
    mode_deposit: 'Deposito',
    max: 'MAX'
  },
  ...
  investments: {
    ...
    invest_fee: 'Commissione Carta ({pct}%):',
    invest_total: 'Addebito Totale:',
  ...
  loans: {
    ...
    interest_accrued: 'Interessi Maturati',
    next_payment: 'Prossimo Pagamento',
    overdue: 'Scaduto!',
    grace_remaining: 'Tempo di Grazia',
    ...
    health_good: 'Buono',
    health_fair: 'Discreto',
    health_poor: 'Scarso',
    health_critical: 'Critico',
    csw: {
      title: 'Punteggio di Credito',
      factors_title: 'Dettaglio Punteggio',
      factors_hint: 'tocca per espandere',
      health_label: 'Salute Portafoglio:',
      utilization_title: 'Rapporto Debito / Limite',
      util_healthy: 'Sano — gran parte del tuo limite è ancora disponibile',
      util_moderate: 'Moderato — oltre metà del limite è occupata, considera di ripagare',
      util_high: 'Alto — quasi al limite, ripaga i prestiti urgentemente',
      util_debt: 'Debito',
      util_limit: 'Limite',
      payment_history: 'Storico Pagamenti',
  ...
  market: {
    ...
    fullscreen_chart: 'Grafico a Schermo Intero',
    data_points: 'Punti Dati',
    prev_close: 'Chiusura Prec.',
    cryptocurrency: 'Criptovaluta',
    stock: 'Azione',
    your_holdings: 'Le Tue Posizioni',
    your_position: 'La Tua Posizione',
    no_holdings: 'Nessuna posizione',
    no_position: 'Nessuna posizione',
    no_position_hint: 'Piazza un ordine di acquisto qui sotto per aprire la tua prima posizione.',
    trade: 'Operazione',
    available: 'Disponibile',
    ...
    // ─── Indicatori Condizione di Mercato ───
    condition_label: 'Condizione di Mercato',
    condition_normal: 'Normale',
    condition_bull: 'Mercato Toro',
    condition_bear: 'Mercato Orso',
    condition_crash: 'Crollo di Mercato',
    condition_bubble: 'Bolla',
    condition_remaining: '{time} rimanenti',

    trend_label: 'Tendenza',
    trend_strong_bull: 'Forte Rialzo',
    trend_bull: 'Rialzo',
    trend_neutral: 'Laterale',
    trend_bear: 'Ribasso',
    trend_strong_bear: 'Forte Ribasso',

    phase_label: 'Fase',
    phase_normal: 'Stabile',
    phase_bubble: 'Bolla',
    phase_correction: 'Correzione',
    phase_crash: 'Crollo',
    phase_recovery: 'Ripresa',

    fear_greed: 'Paura & Avidità',
    fear_extreme: 'Paura Estrema',
    fear: 'Paura',
    neutral: 'Neutro',
    greed: 'Avidità',
    greed_extreme: 'Avidità Estrema',

    volatility_index: 'Volatilità',
    vol_low: 'Bassa',
    vol_moderate: 'Moderata',
    vol_high: 'Alta',
    vol_extreme: 'Estrema',

    momentum_short: 'Breve termine',
    momentum_medium: 'Medio termine',
  ...
  orders: {
    limit: 'Limite',
    type_limit_buy: 'Acquisto Limite',
    type_limit_sell: 'Vendita Limite',
    ...
    est_fee: 'Commissione ({pct}%):',
    est_total: 'Totale:',
    est_revenue: 'Ricavo Stim.:',
    notify_expired: 'Ordine scaduto',
    notify_failed: 'Esecuzione ordine fallita',
    notify_filled: 'Ordine eseguito',
    set_market: 'Imposta prezzo di mercato',
    ...
    tip_pct_preset: 'Usa il {pct}% dei tuoi contanti disponibili',
    tip_sell_all: 'Vendi tutta la tua posizione al prezzo di mercato',
  ...
  storage: {
    ...
    intimidate_counter: 'Ha contrattaccato!',
    intimidate_scared: 'Scosso, ma resta...',
    intimidate_unfazed: 'Impassibile.',
    bluff_fooled: 'Ci è cascato!',
    bluff_called: 'Ha scoperto il bluff!',
    bluff_unfazed: 'Non ci è cascato.',
    sniper_caught_off_guard: 'Colto alla sprovvista!',
    sniper_dropped: 'Troppo lento — ritirato!',
    sniper_countered: 'Ha reagito in tempo!',

    // Tell degli NPC
    tell_shifting_weight: 'Si muove nervosamente...',
    tell_biting_lip: 'Si morde il labbro...',
    tell_checking_phone: 'Controlla il telefono...',
    tell_cracking_knuckles: 'Si fa scrocchiare le nocche...',
    tell_leaning_forward: 'Si sporge in avanti...',
    tell_staring_down: 'Ti fissa con intensità...',
    ...
    lot_tier_legendary_desc: 'Il lotto del secolo. Attenzione — la posta in gioco è altissima.',

    // Lot Events
    lot_has_events: 'Questo lotto ha eventi attivi!',
