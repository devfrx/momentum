...
export const PRESTIGE_PERKS: PerkDef[] = [
  // ─── Quality of Life Perks ──────────────────────────────────────
  {
    ...
    cost: D(5),
    effect: { type: 'starting_cash', value: 5000, permanent: true },
    prerequisites: [],
  ...
  // ─── Boost Perks ────────────────────────────────────────────────
  {
    ...
    name: 'Market Insight',
    description: 'All stock investments gain 3% better returns.',
    icon: 'mdi:chart-line',
    cost: D(50),
  ...
  {
    id: 'perk_crypto_insight',
    name: 'Crypto Insight',
    description: 'All crypto investments gain 3% better returns and staking rewards.',
    icon: 'mdi:bitcoin',
    cost: D(50),
    effect: { type: 'crypto_returns', value: 0.03, permanent: true },
    prerequisites: [],
    category: 'boost',
    eraRequired: 'era_titan',
  },
  ...
  },
  {
    id: 'perk_xp_mastery',
    name: 'XP Mastery',
    description: 'Gain 5% more experience from all sources.',
    icon: 'mdi:school',
    cost: D(250),
    effect: { type: 'xp_gain', value: 0.05, permanent: true },
    prerequisites: ['perk_market_insight'],
    category: 'boost',
    eraRequired: 'era_titan',
  },
