 ...
 *
 * ── Balance guidelines ──
 * ROI  = baseRent × units / price.  Targets a DECREASING daily-ROI% from
 *        Studio (fastest payback ~4h) to Private Castle (slowest ~40h) so
 *        early properties feel rewarding while late-game relies on higher
 *        absolute income and appreciation.  All values assume grade-B (1.0).
 *
 * Appreciation rates are tuned for the 6 000-tick period (~10 min).
 * A rate of 0.00015 gives ~2.2 %/day; 0.00030 gives ~4.4 %/day.
...
export const PROPERTY_TEMPLATES: PropertyTemplate[] = [
  ...
  },
  {
    ...
    baseRentRange: [0.90, 1.9],
    unitRange: [3, 6],
    conditionRange: [55, 100],
    wearRateRange: [0.0012, 0.002],
    taxRateRange: [0.012, 0.017],
    baseAppreciationRate: 0.00018,
    maintenanceRatio: 0.09,
  ...
  },
  {
    ...
    baseRentRange: [2.7, 5.6],
    unitRange: [5, 20],
    conditionRange: [60, 100],
    wearRateRange: [0.001, 0.002],
    taxRateRange: [0.017, 0.023],
    baseAppreciationRate: 0.00013,
    maintenanceRatio: 0.10,
  ...
  },
  {
    ...
    baseRentRange: [5.2, 11.0],
    unitRange: [60, 150],
    conditionRange: [70, 100],
    wearRateRange: [0.002, 0.003],
    taxRateRange: [0.015, 0.021],
    baseAppreciationRate: 0.00014,
    maintenanceRatio: 0.11,
  ...
  // ── Luxury ──
  {
    ...
    baseRentRange: [14.0, 28.0],
    unitRange: [4, 12],
    conditionRange: [80, 100],
    wearRateRange: [0.001, 0.002],
    taxRateRange: [0.012, 0.017],
    baseAppreciationRate: 0.00022,
  ...
  },
  {
    ...
    baseRentRange: [23.0, 48.0],
    unitRange: [50, 120],
    conditionRange: [80, 100],
    wearRateRange: [0.001, 0.0015],
    taxRateRange: [0.017, 0.029],
    baseAppreciationRate: 0.00020,
  ...
  // ── Industrial ──
  {
    ...
    baseRentRange: [1.2, 2.5],
    unitRange: [1, 4],
    conditionRange: [40, 85],
    wearRateRange: [0.0005, 0.001],
    taxRateRange: [0.009, 0.014],
    baseAppreciationRate: 0.00010,
  ...
  },
  {
    ...
    baseRentRange: [3.6, 7.5],
    unitRange: [2, 8],
    conditionRange: [40, 80],
    wearRateRange: [0.001, 0.002],
    taxRateRange: [0.012, 0.017],
    baseAppreciationRate: 0.00009,
