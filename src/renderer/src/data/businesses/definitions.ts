 ...
 * Output scales polynomially: level^0.75  (LEVEL_OUTPUT_EXPONENT)
 *   → tracks closely with demand (level^0.7), keeping utilization healthy across all levels
 *
 * Balance targets (level 1, full staff, optimal price, no multipliers):
 *   - All businesses profitable: margins 27–36%
 *   - ROI curve: 5 min (starter) → 6.7 hrs (endgame)
...
/** Output growth base per level (exponential: base^level) */
export const LEVEL_OUTPUT_EXPONENT = 0.75
export const LEVEL_OUTPUT_BASE = 1.15
...
export const BUSINESS_DEFS: BusinessDef[] = [
  {
    ...
    icon: 'mdi:cup',
    purchasePrice: D(14000),
    category: 'Starter',
    unlockAtNetWorth: D(6000),
  ...
  },
  {
    ...
    icon: 'mdi:newspaper',
    purchasePrice: D(72000),
    category: 'Starter',
    unlockAtNetWorth: D(32000),
  ...
  },
  {
    ...
    icon: 'mdi:car-wash',
    purchasePrice: D(390000),
    category: 'Services',
    unlockAtNetWorth: D(175000),
  ...
  },
  {
    ...
    icon: 'mdi:pizza',
    purchasePrice: D(1300000),
    category: 'Food',
    unlockAtNetWorth: D(580000),
  ...
  },
  {
    ...
    icon: 'mdi:dumbbell',
    purchasePrice: D(6300000),
    category: 'Services',
    unlockAtNetWorth: D(2800000),
  ...
  },
  {
    ...
    icon: 'mdi:hanger',
    purchasePrice: D(29000000),
    category: 'Retail',
    unlockAtNetWorth: D(13000000),
  ...
  },
  {
    ...
    purchasePrice: D(150000000),
    category: 'Food',
    unlockAtNetWorth: D(68000000),
  ...
  },
  {
    ...
    icon: 'mdi:music-note',
    purchasePrice: D(800000000),
    category: 'Entertainment',
    unlockAtNetWorth: D(360000000),
  ...
  },
  {
    ...
    icon: 'mdi:laptop',
    purchasePrice: D(40000000000),
    category: 'Tech',
    unlockAtNetWorth: D(18000000000),
  ...
  },
  {
    ...
    icon: 'mdi:factory',
    purchasePrice: D(290000000000),
    category: 'Industry',
    unlockAtNetWorth: D(130000000000),
    ...
    branchBaseCost: D(1450000000000),
    maxEmployeesBase: 25,
  ...
  },
  {
    ...
    icon: 'mdi:bank',
    purchasePrice: D(2600000000000),
    category: 'Finance',
    unlockAtNetWorth: D(1170000000000),
    ...
    branchBaseCost: D(13000000000000),
    maxEmployeesBase: 20,
