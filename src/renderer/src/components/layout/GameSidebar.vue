...
const ROUTE_ORDER = ['/', '/business', '/stocks', '/crypto', '/realestate', '/investments', '/loans', '/deposits', '/gambling', '/storage', '/blackmarket', '/skills', '/prestige', '/settings', '/dev']
...
const GROUP_DEFS = [
    ...
    { labelKey: 'nav.group_fun', paths: ['/gambling', '/storage', '/blackmarket'] },
